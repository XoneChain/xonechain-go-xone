...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gxone.ipc", false, filepath.Join(os.TempDir(), "gxone.ipc")},
		{"data", "gxone.ipc", false, "data/gxone.ipc"},
		{"data", "./gxone.ipc", false, "./gxone.ipc"},
		{"data", "/gxone.ipc", false, "/gxone.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gxone.ipc", true, `\\.\pipe\gxone.ipc`},
		{"data", "gxone.ipc", true, `\\.\pipe\gxone.ipc`},
		{"data", `\\.\pipe\gxone.ipc`, true, `\\.\pipe\gxone.ipc`},
	}
