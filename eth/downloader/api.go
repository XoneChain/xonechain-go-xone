...
// Syncing provides information when this nodes starts synchronising with the Xonechain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  xonechain.SyncProgress `json:"status"`
}
