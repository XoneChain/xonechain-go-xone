...
import (
	...
	"github.com/xonechain/go-xone/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Xonechain
...
func (eth *Xonechain) startBloomHandlers() {
...
// for the Xonechain header bloom filters, permitting blazing fast filtering.
