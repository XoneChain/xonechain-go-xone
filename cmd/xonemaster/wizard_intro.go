...
// makeWizard creates and returns a new xonemaster wizard.
...
// setting up a new or managing an existing Xonechain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to xonemaster, your Xonechain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Xonechain network down to  |")
	fmt.Println("| the genesis block, xoneboots, miners and ethstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Xonemaster uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering Xonechain network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".xonemaster", w.network)
