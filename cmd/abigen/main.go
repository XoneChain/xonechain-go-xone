...
import (
	...
	"github.com/xonechain/go-xone/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Xonechain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Xonechain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Xonechain contract Solidity source to build and bind")
