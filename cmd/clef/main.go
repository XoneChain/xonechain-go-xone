...
import (
	...
	"github.com/xonechain/go-xone/signer/core"
	"github.com/xonechain/go-xone/signer/rules"
	"github.com/xonechain/go-xone/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Xonechain account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
