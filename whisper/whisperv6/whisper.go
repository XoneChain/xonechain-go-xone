...
// Whisper represents a dark communication interface through the Xonechain
...
// New creates a Whisper client ready to communicate through the Xonechain P2P network.
