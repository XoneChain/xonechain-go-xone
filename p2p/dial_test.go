...
// Tests that xoneboots are dialed if no peers are connectd, but not otherwise.
func TestDialStateDynDialXoneboot(t *testing.T) {
	xoneboots := []*discover.Node{
		{ID: uintID(1)},
		{ID: uintID(2)},
		{ID: uintID(3)},
	}
	...
	runDialTest(t, dialtest{
		init: newDialState(nil, xoneboots, table, 5, nil),
		rounds: []round{
			// 2 dynamic dials attempted, xoneboots pending fallback interval
			{
				new: []task{
					&dialTask{flags: dynDialedConn, dest: &discover.Node{ID: uintID(4)}},
					&dialTask{flags: dynDialedConn, dest: &discover.Node{ID: uintID(5)}},
			...
			// No dials succeed, xoneboots still pending fallback interval
			{
				done: []task{
					&dialTask{flags: dynDialedConn, dest: &discover.Node{ID: uintID(4)}},
					&dialTask{flags: dynDialedConn, dest: &discover.Node{ID: uintID(5)}},
			...
			// No dials succeed, xoneboots still pending fallback interval
			{},
			// No dials succeed, 2 dynamic dials attempted and 1 xoneboot too as fallback interval was reached
			{
				new: []task{
			...
			// No dials succeed, 2nd xoneboot is attempted
			{
				done: []task{
					&dialTask{flags: dynDialedConn, dest: &discover.Node{ID: uintID(1)}},
					&dialTask{flags: dynDialedConn, dest: &discover.Node{ID: uintID(4)}},
			...
			// No dials succeed, 3rd xoneboot is attempted
			{
				done: []task{
					&dialTask{flags: dynDialedConn, dest: &discover.Node{ID: uintID(2)}},
				},
			...
			// No dials succeed, 1st xoneboot is attempted again, expired random nodes retried
			{
				done: []task{
					&dialTask{flags: dynDialedConn, dest: &discover.Node{ID: uintID(3)}},
				},
			...
			// Random dial succeeds, no more xoneboots are attempted
			{
				peers: []*Peer{
					{rw: &conn{flags: dynDialedConn, id: uintID(4)}},
				},
