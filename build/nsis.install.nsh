Name "gxone ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/xonechain/go-xone/issues"
!define UPDATEURL "https://github.com/xonechain/go-xone/releases"
!define ABOUTURL "https://github.com/xonechain/go-xone#xonechain-go"
...
# Install gxone binary
Section "Gxone" GXONE_IDX
  SetOutPath $INSTDIR
  file {{.Gxone}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gxone.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gxone.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gxone incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gxone outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gxone UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gxone incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gxone.exe" "" "" "Xonechain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gxone outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gxone.exe" "" "" "Xonechain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gxone UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gxone.exe" "" "" "Xonechain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/xonechain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gxone.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gxone.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GXONE_IDX}
    SectionGetSize ${GXONE_IDX} $0
