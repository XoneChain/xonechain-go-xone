...
# 1. install gxone for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gxone
# 5. create gxone, attach and uninstall start menu entries
...
!define GROUPNAME "Xonechain"
!define APPNAME "Gxone"
!define DESCRIPTION "Official Go implementation of the Xonechain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gxone is installed global
