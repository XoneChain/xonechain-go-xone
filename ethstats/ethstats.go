...
import (
	...
	"github.com/xonechain/go-xone/common/mclock"
...
// Service implements an Xonechain netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Xonechain      // Full Xonechain service if monitoring a full node
	les    *les.LightXonechain // Light Xonechain service if monitoring a light node
...
func New(url string, ethServ *eth.Xonechain, lesServ *les.LightXonechain) (*Service, error) {
