...
import (
	...
	"github.com/xonechain/go-xone/internal/jsre"
	"github.com/xonechain/go-xone/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Xonechain requests through
...
// Welcome show summary of current Gxone instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gxone metadata
	fmt.Fprintf(c.printer, "Welcome to the Gxone JavaScript console!\n\n")
	c.jsre.Run(`
