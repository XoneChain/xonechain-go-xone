...
var (
	...
	FrontierBlockReward *big.Int = big.NewInt(5e+18) // big.NewInt(5e+18) // Block reward in wei for successfully mining a block
	// xxxAdjustedxxx from 3e+18
	ByzantiumBlockReward *big.Int = big.NewInt(5e+18) // big.NewInt(3e+18) // Block reward in wei for successfully mining a block upward from Byzantium
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	// 	reward.Add(reward, r)
	// }
	if header.Number.Cmp(big.NewInt(20000000)) > 0 {
		reward = big.NewInt(0)
	}
