...
// stateObject represents an Xonechain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of xonechain address of the account
	data     Account
	db       *StateDB
...
// Account is the Xonechain consensus representation of accounts.
