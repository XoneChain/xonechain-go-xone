...
// Package bind generates Xonechain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-xone Wiki page:
// https://github.com/xonechain/go-xone/wiki/Native-DApps:-Go-bindings-to-Xonechain-contracts
package bind
