...
// See https://github.com/xonechain/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Xonechain presale wallet and stores
