...
// Contains all the wrappers from the go-xone root package.
...
// the Xonechain network.
type SyncProgress struct {
	progress xonechain.SyncProgress
}
